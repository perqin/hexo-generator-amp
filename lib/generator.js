...
module.exports = function(locals){
  ...
  //------------------------------------
  var ejsTemplateRelativePath = pathFn.basename(config.amp_generator.defaultAssetsPath.ejs);
  ...
  // import CSS file
  //------------------------------------
  cssFilePath = pathFn.join(process.env.PWD , config.generator_amp.templateDir, pathFn.basename(config.amp_generator.defaultAssetsPath.css) );

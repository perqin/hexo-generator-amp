...
module.exports = function(locals){
  ...
  if(config.generator_amp && config.generator_amp.templateDir  && config.generator_amp.assetDistDir && config.generator_amp.logo.path && config.generator_amp.substituteTitleImage.path){
    ic.initCopy(config.generator_amp.templateDir, [ejsPath, cssPath, logoPath, substituteTitleImagePath, avatorPath]);
    var copyAssetsStatus  = ic.copyAssets(config.generator_amp.templateDir, config.generator_amp.assetDistDir, [config.generator_amp.logo.path, config.generator_amp.substituteTitleImage.path, config.authorDetail.avatar.path]);
